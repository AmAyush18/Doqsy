...
export function AppointmentCard({
  ...
  return (
    <>
      <Card className="border-slate-900/20 hover:border-slate-700/30 transition-all">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                <div className="h-5 w-5 text-slate-400 mr-2">
                  {otherPartyIcon}
                </div>
                <div>
            ...
            {appointment.patientDescription && (
              <div className="space-y-2">
                ...
                <div className="p-3 rounded-md bg-muted/20 border border-slate-900/20">
                ...
                {userRole === "DOCTOR" &&
                  ...
                  appointment.status !== "CANCELLED" && (
                    <Button
                      ...
                      className="h-7 text-slate-400 hover:text-slate-300 hover:bg-slate-900/20"
                    >
              ...
              {userRole === "DOCTOR" && action === "notes" ? (
                <div className="space-y-3">
                  <Textarea
                    ...
                    className="bg-background border-slate-900/20 min-h-[100px]"
                  />
                ...
                <div className="p-3 rounded-md bg-muted/20 border border-slate-900/20 min-h-[80px]">
                  {appointment.notes ? (
                    <p className="text-white whitespace-pre-line">
                      {appointment.notes}
                    </p>
