      ...
      <CardContent>
        ...
        {!showForm ? (
              ...
              {slots.length === 0 ? (
                ...
                <div className="space-y-3">
                  {slots.map((slot) => (
                    <div
                      key={slot.id}
                      className="flex items-center p-3 rounded-md bg-muted/20 border border-slate-900/20"
                    >
                      <div className="bg-slate-900/20 p-2 rounded-full mr-3">
          ...
          <form
            ...
            className="space-y-4 border border-slate-900/20 rounded-md p-4"
          >
        ...
        <div className="mt-6 p-4 bg-muted/10 border border-slate-900/10 rounded-md">
