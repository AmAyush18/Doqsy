        ...
        <Card className="border-slate-900/20">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-slate-900/20 p-3 rounded-full">
      ...
      <Card className="border-slate-900/20">
        <CardHeader>
          <CardTitle className="text-xl font-bold text-white flex items-center">
            <CreditCard className="h-5 w-5 mr-2 text-slate-400" />
            Payout Management
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          {/* Current Payout Status */}
          <div className="bg-muted/20 p-4 rounded-lg border border-slate-900/20">
            <div className="flex items-center justify-between mb-3">
              ...
              {pendingPayout ? (
                ...
                <Badge
                  variant="outline"
                  className="bg-slate-900/20 border-slate-900/30 text-slate-400"
                >
                  Available
                </Badge>
              )}
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                {payouts.slice(0, 5).map((payout) => (
                  <div
                    key={payout.id}
                    className="flex items-center justify-between p-3 rounded-md bg-muted/10 border border-slate-900/10"
                  >
                    <div>
                      <p className="text-white font-medium">
                    ...
                    <Badge
                      ...
                      className={
                        payout.status === "PROCESSED"
                          ? "bg-slate-900/20 border-slate-900/30 text-slate-400"
        ...
        <DialogContent>
          ...
          <form onSubmit={handlePayoutRequest} className="space-y-4">
            <div className="bg-muted/20 p-4 rounded-lg space-y-2">
              ...
              <div className="border-t border-slate-900/20 pt-2 flex justify-between font-medium">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-background border-slate-900/20"
                required
              />
              <p className="text-sm text-muted-foreground">
