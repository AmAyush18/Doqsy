          ...
          <Card className="border-slate-900/20">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                <div className="relative w-32 h-32 rounded-full overflow-hidden mb-4 bg-slate-900/20">
                  {doctor.imageUrl ? (
                    <Image
                      src={doctor.imageUrl}
                      alt={doctor.name}
                ...
                <Badge
                  variant="outline"
                  className="bg-slate-900/20 border-slate-900/30 text-slate-400 mb-4"
                >
                  {doctor.specialty}
                </Badge>

                <div className="flex items-center justify-center mb-2">
                  <Medal className="h-4 w-4 text-slate-400 mr-2" />
      ...
      <div className="md:col-span-2 space-y-6">
        <Card className="border-slate-900/20">
          ...
          <CardContent className="space-y-6">
            ...
            <Separator className="bg-slate-900/20" />
